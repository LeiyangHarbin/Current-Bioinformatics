...
#reut = np.loadtxt(r'D:\\SDQ\\BRCA-metabolic\\7-TCGA\\gsva-cox\\metabolic_NES1.txt', dtype=float)##
reut = np.loadtxt('metabolicNES1.txt', dtype=float)##
label = np.loadtxt('metabolicNES1_label.txt', dtype=int)##
